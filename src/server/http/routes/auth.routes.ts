...
export const authRoutes = new Hono()
	.post('/login', strictRateLimit, loginRequest, authController.login)
	.post('/register', strictRateLimit, registerRequest, authController.register)
	...
	.post('/forgot-password', strictRateLimit, forgotPasswordRequest, authController.forgotPassword)
